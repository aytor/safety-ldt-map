# Description
The code runs the results obtained for the paper: [Large Deviations in Safety-Critical Systems with Probabilistic Initial Conditions](https://arxiv.org/abs/2405.13506)
...
# Dependencies
The method relies on solving a variational problems, which we formulate in MATLAB and solve using CasADi.
